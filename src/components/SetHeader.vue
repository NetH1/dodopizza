<template>
  <div class="flex items-center justify-between my-5 px-4 lg:px-0">
    <div class="flex">
      <svg @click="$router.push({ name: 'mainPage'})" class="h-11 lg:mr-8 hover:cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 247 44.59">
    ...
    <div>
      <button class="bg-main text-white p-2 rounded-lg">Корзина <span v-if="orders != null" class="text-black font-bold">{{ orders[0].goods.length }}</span></button>
...
export default {
  ...
  async created() {
    let res = await axios.get('https://627a34aa73bad506858480a8.mockapi.io/api/orders');
